...
function Dashboard(
    ...
    <nav className={`sidebar ${isSidebarOpen ? '' : 'close'} ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="menu-bar">
        ...
        <div className="top-navbar">
          <div className="logo-text"><div className='head'>PlantPro Dashboard</div></div>
  ...
  <span className="container1-label">Light 1</span>
  <label className="switch">
    ...
    <span className="slider"></span>
        ...
        <div className="light-container">
          <span className="container1-label">Light 2</span>
          <label className="switch">
            <input type="checkbox" />
            <span className="slider"></span>
          </label>
        ...
        <div className="motor-container">
          <span className="container1-label">Motor1</span>
          <label className="switch">
            <input type="checkbox" />
            <span className="slider"></span>
          </label>
        ...
        <div className="light-container">
          <span className="container-label">Last Watered Time</span>
          <span className="container-value">8:00pm</span>
        </div>
      ...
      <img src="graph.png" className='grap'></img>
        </li>
      </div>
    </nav>
    <DWeather/>
